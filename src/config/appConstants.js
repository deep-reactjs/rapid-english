...
const Constants = {
  ...
  GOOGLE_SIGNIN_KEY_IOS:
    '656287987720-97fh1sj3aojhdvlg4a5f4jh2mqu7qmer.apps.googleusercontent.com',
  SENTRY_INTERNAL_DSN: '',
  ...
  // BANNER_KEY:
  //   'ca-app-pub-39402560999425449214589741' || Platform.OS == 'android'
  //     ? 'ca-app-pub-9542796943771971/4018042184'
  //     : 'ca-app-pub-9542796943771971/4354636226',
  // REWARDED:
  //   'ca-app-pub-39402560999425445224354917' || Platform.OS == 'android'
  //     ? 'ca-app-pub-9542796943771971/5327927186'
  //     : 'ca-app-pub-9542796943771971/4660561397',
  // REWARDED_INTERSTITIAL:
  //   Platform.OS === 'android'
  ...
  //     : 'ca-app-pub-9542796943771971/4660561397',
  // INTERSTITIAL__KEY:
  //   'ca-app-pub-39402560999425441033173712' || Platform.OS == 'android'
  //     ? 'ca-app-pub-9542796943771971/6006783416'
  //     : 'ca-app-pub-9542796943771971/4602596976',
};
...
const Strings = {
  ...
  synonyms: 'Synonyms',
  antonyms: 'Antonyms',
  appleAuthError: 'Unsuccessful, Email not found for this account',
};
